<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        @guest
            <li class="nav-item">
                <a class="nav-link text-primary" href="/login" aria-haspopup="true" aria-expanded="false">
                    Bertanya
                    <i class="fas fa-question fa-fw"></i>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-gray-600 small"
        ...
        @else
            <li class="nav-item">
                <a class="nav-link text-primary" href="/question" aria-haspopup="true" aria-expanded="false">
                    Bertanya
                    <i class="fas fa-question fa-fw"></i>
                </a>
            </li>
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                    ...
                    <img class="img-profile rounded-circle" src="https://api.adorable.io/avatars/285/{{ Auth::user()->email }}.png">
                </a>
